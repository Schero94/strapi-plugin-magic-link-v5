                ...
                <Box padding={7}>
                  <Flex direction="column" alignItems="stretch" gap={5}>
                    ...
                    <Flex alignItems="center" gap={3}>
                      <Typography variant="sigma" fontWeight="semiBold" textColor="neutral500" style={{ fontSize: '12px' }}>
                    ...
                    >
                      ...
                      >
                        <Typography variant="omega" fontWeight="semiBold" textColor="neutral600" style={{ fontSize: '13px' }}>
                      ...
                      >
                        <Typography variant="omega" textColor="neutral500" style={{ fontSize: '13px' }}>
                          {formatMessage({ id: getTrad('tokens.details.created') })}
                        </Typography>
                        <Typography variant="pi" textColor="neutral800" style={{ fontSize: '13px', fontWeight: '600' }}>
                      ...
                      {selectedTokenDetails.used_at && (
                        ...
                        >
                          ...
                          <Flex alignItems="center" gap={2}>
                            ...
                            <Typography variant="pi" textColor="success600" style={{ fontSize: '13px', fontWeight: '600' }}>
                    ...
                    {(selectedTokenDetails.ip_address || selectedTokenDetails.user_agent) && (
                      <Box>
                        <Typography variant="sigma" fontWeight="semiBold" textColor="neutral500" style={{ marginBottom: '8px', textTransform: 'uppercase', fontSize: '11px', letterSpacing: '0.5px' }}>
                        ...
                        >
                          <Flex direction="column" gap={2}>
                            {selectedTokenDetails.ip_address && (
                              <Flex alignItems="center" gap={2}>
                                <Earth style={{ width: '14px', height: '14px', color: 'var(--colors-neutral500)' }} />
                    ...
                    <Box style={{ marginTop: '8px' }}>
                      <Typography variant="sigma" fontWeight="semiBold" textColor="neutral500" style={{ marginBottom: '12px', textTransform: 'uppercase', fontSize: '11px', letterSpacing: '0.5px' }}>
